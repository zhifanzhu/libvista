...
axis_out_fmt = 'tests/geometry/outputs/pr_axis_standardized.{coor_sys}.png'
cube_out_fmt = 'tests/geometry/outputs/pr_cube_standardized.{coor_sys}.png'
hand_out_fmt = 'tests/geometry/outputs/pr_hand_standardized.{coor_sys}.png'
multi_hand_out_fmt = 'tests/geometry/outputs/pr_multihand_standardized.{coor_sys}.png'

class PRProjectionStandardizedTest(unittest.TestCase):
